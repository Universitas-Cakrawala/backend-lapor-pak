import { IsString, IsEmail, IsNotEmpty, MinLength, MaxLength, Matches, ValidateIf } from 'class-validator';
import { ApiProperty } from '@nestjs/swagger';

export class RegisterDto {
  @ApiProperty({ description: 'Username untuk login', example: 'johndoe', minLength: 3, maxLength: 30 })
  ...
  @ApiProperty({ description: 'Password akun', example: 'secret123', minLength: 8 })
